...
// // // .then((data) => {
// // //     // console.log(data); // got json format data
...
// // let class1 = document.querySelectorAll(".one")
...
// // let groupHi = document.querySelectorAll(".hi")

// // console.log(groupHi[0]);
...
// let fourth=(child3.nextElementSibling);//nextSibilingElement
...
// // // remain tag inside value u want manipulate    :- (1. innerText, 2.TextContent, 3.innerHTML)
...
// // para.innerHTML = `<h1>ben10</h1> <h4>Gwen</h4>`
...
button.addEventListener("click",()=>{
    ...
    // one tag inside give another tag = append
